...
google https://www.pipl.com/search/? q=$nombre+$apellido &
sleep 1
google -new-tab http://411.com/name/$nombre-$apellido&
sleep 1 
...
google  https://medium.com/@bloodbathalchemis/gu%C3%ADa-termux-instalando-lenguajes-y-herramientas-b9e3c2be196f
